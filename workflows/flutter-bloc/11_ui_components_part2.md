---
description: Library widget reusable yang konsisten: AppButton, AppTextField, AppCard, shimmer, empty state, error widget. Semua w... (Part 2/4)
---
# 11 - UI Components (Reusable Widget Library) (Part 2/4)
