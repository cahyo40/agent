# 11 - UI Components (Reusable Widget Library)

**Goal:** Library widget reusable yang konsisten: AppButton, AppTextField, AppCard, shimmer, empty state, error widget. Semua widget framework-agnostic (tidak bergantung pada BLoC).

**Output:** `sdlc/flutter-bloc/11-ui-components/`
...
## Next Steps
- `12_push_notifications.md` - Push notifications
