...
---
# Workflow: Translation & Localization (GetX i18n)

// turbo-all

## Overview

Implementasi internationalization (i18n) untuk Flutter dengan
GetX translations: multi-language support, locale switching,
dan string management.


## Prerequisites

- Project setup dari `01_project_setup.md` selesai
- UI components selesai (`03_ui_components.md`)


## Agent Behavior

- **Gunakan GetX Translations** — bukan easy_localization.
- **Selalu gunakan `.tr` extension** — bukan hardcoded strings.
- **Support minimal 2 bahasa** — default + 1 tambahan.
