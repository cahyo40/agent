...
---
# Workflow: Backend Integration (REST API + Dio)

// turbo-all

## Overview

Implementasi repository pattern dengan REST API menggunakan Dio:
interceptors, error handling, token refresh, pagination, dan
optimistic updates.
...
- **Jangan hardcode base URL** — gunakan env configuration.
- **Selalu implement error mapper** — DioException → AppException.
- **Implement token refresh** — di auth interceptor.
