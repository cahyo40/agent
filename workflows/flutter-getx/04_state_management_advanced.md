...
---
# Workflow: Advanced State Management (GetX Patterns)

// turbo-all

## Overview

Pola-pola advanced GetX untuk production apps: Workers,
StateMixin, pagination, optimistic updates, dan cross-controller
communication.
...
- **Gunakan GetxController** dengan StateMixin untuk async state.
- **Implement proper dispose** — cancel subscriptions, workers.
- **Gunakan Workers** — ever, debounce, interval untuk reactive patterns.
- **Gunakan Get.find()** untuk cross-controller communication.
...
**Output:** `sdlc/flutter-getx/08-state-management-advanced/`
