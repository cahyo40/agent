...
# "Run workflow 01_project_setup.md from flutter-getx workflows"
...
# "Generate feature 'Todo' dengan workflow 02_feature_maker.md from flutter-getx"
...
# 2. Jalankan workflow:
# "Integrate REST API with workflow 03_backend_integration.md from flutter-getx"
...
# 4. Jalankan workflow:
# "Integrate Firebase dengan workflow 04_firebase_integration.md from flutter-getx"
...
# 3. Jalankan workflow:
# "Integrate Supabase dengan workflow 05_supabase_integration.md from flutter-getx"
...
```bash
# 1. Jalankan workflow:
# "Setup testing dan production dengan workflow 06_testing_production.md from flutter-getx"
...
```bash
# 1. Jalankan workflow:
# "Setup translation dengan workflow 07_translation.md from flutter-getx"
...
```
Run workflow 01_project_setup.md from flutter-getx workflows to create
...
- Output to: sdlc/flutter-getx/01-project-setup/
```
...
Generate to: sdlc/flutter-getx/02-feature-maker/order/
```
...
Output to: sdlc/flutter-getx/03-backend-integration/
```
...
Output to: sdlc/flutter-getx/04-firebase-integration/
```
...
Output to: sdlc/flutter-getx/05-supabase-integration/
```

#### 6. Translation & Localization

```
Setup translation using workflow 07_translation.md from flutter-getx
workflows:
...
Output to: sdlc/flutter-getx/07-translation/
```
