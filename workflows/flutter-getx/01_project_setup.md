---
description: Setup Flutter project dari nol dengan Clean Architecture dan GetX state management.
---
# Workflow: Project Setup (Flutter + GetX + Clean Architecture)

// turbo-all

## Overview

Setup Flutter project dari nol dengan Clean Architecture dan GetX
state management. Include folder structure, dependencies, theme,
routing, error handling, dan example feature.


## Prerequisites

- Flutter SDK 3.41.1+ installed
- IDE dengan Dart/Flutter plugin


## Agent Behavior

- **Jangan tanya nama project** — gunakan nama folder saat ini.
...
- **Gunakan latest stable versions** — cek pub.dev jika ragu.


## Recommended Skills

- `senior-flutter-developer` — Flutter + GetX patterns
...
abstract class ProductRepository {
  ...
  Future<Result< Unit>> deleteProduct(String id);
}
...
# Utils
flutter pub add equatable json_annotation
