...
### Pre-Execution
- [ ] Part 1 completed (Handoff Checklist, KT Plan, Acceptance Doc)
- [ ] Project metrics collected
- [ ] Team availability for retrospective confirmed

### During Execution
- [ ] Post-Launch Review document created
- [ ] Project metrics analyzed (timeline, budget, quality)
- [ ] Lessons learned documented (What went well, What could be improved)
- [ ] Action items created for future projects
- [ ] Team kudos recognized
- [ ] Archive location documented

### Post-Execution
- [ ] Post-Launch Review completed
- [ ] Action items assigned to owners
- [ ] Lessons learned archived for future reference
- [ ] Project archive complete (repo, docs, recordings)
- [ ] Warranty period terms confirmed
- [ ] Support escalation contacts updated
- [ ] Project closure communicated to stakeholders
...
- **Related** → `01_requirement_analysis.md` (for comparing initial vs final scope)
