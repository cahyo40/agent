# Flutter Riverpod + YoUI Workflows - User Guide
...
- Add shimmer loading
- Output to: sdlc/flutter-youi-riverpod/01-project-setup/
```
...
Generate to: sdlc/flutter-youi-riverpod/02-feature-maker/order/
```
...
Output to: sdlc/flutter-youi-riverpod/03-backend-integration/
```
...
Output to: sdlc/flutter-youi-riverpod/04-firebase-integration/
```
...
Output to: sdlc/flutter-youi-riverpod/07-translation/
```
...
Output to: sdlc/flutter-youi-riverpod/06-testing-production/
```
