---
description: Implementasi repository pattern dengan REST API menggunakan Dio. (Part 1/4)
---
# Workflow: Backend Integration (REST API) (Part 1/4)
...
**Base Folder:** `sdlc/flutter-youi-riverpod/03-backend-integration/`
