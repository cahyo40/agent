---
description: Integrasi Supabase sebagai alternative backend: Authentication, PostgreSQL Database, Realtime subscriptions, dan Storage. (Part 1/4)
---
# Workflow: Supabase Integration (Part 1/4)
...
**Base Folder:** `sdlc/flutter-youi-riverpod/05-supabase-integration/`
