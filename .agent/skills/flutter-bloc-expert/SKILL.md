...
description: "Expert Flutter BLoC pattern including Cubit, Bloc, state management, testing, and scalable architecture"
---
...
This skill helps you implement the BLoC pattern effectively for predictable, testable state management in Flutter.

## When to Use This Skill

- Use when implementing BLoC pattern
- Use when managing complex state
- Use when working with existing BLoC codebase
- Use when comparing BLoC vs Riverpod

## How It Works

### Step 1: BLoC vs Cubit
...
- ✅ Use BlocObserver for logging
- ✅ Test all state transitions
- ✅ Use event transformers wisely
...
- `@flutter-testing-specialist` - Testing
